...
public class MapIsolateServerRunner extends AbstractMapServer {
    ...
    public static final String MAP_ID = "f363bbd3-db9d-4957-bcc6-11b0ffa3a456";
    ...
    protected void prepareStart() {
        ...
        try {
            var map = mapService().getMap(Uuids.ZERO, MAP_ID);
    ...
    protected void handleConfigPhase(@NotNull AsyncPlayerConfigurationEvent event) {
        try {
            ...
            var presence = new Presence(Presence.TYPE_MAPMAKER_MAP, "playing", instanceId, MAP_ID);
