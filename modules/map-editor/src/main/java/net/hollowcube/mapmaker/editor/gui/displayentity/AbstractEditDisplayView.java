...
import net.hollowcube.mapmaker.editor.gui.displayentity.search.SearchDisplaysView;
...
public class AbstractEditDisplayView<E extends DisplayEntity, M extends AbstractDisplayMeta> extends View {
    ...
    private void onDeselectClick(@NotNull Player player) {
        DisplayEntityEditor.setSelectedDisplayEntity(player, null);
        player.closeInventory();
    }
    ...
    private void onSearchDisplaySelected(UUID uuid) {
        ...
        if (entity instanceof DisplayEntity it) {
            DisplayEntityEditor.setSelectedDisplayEntity(player, it);
