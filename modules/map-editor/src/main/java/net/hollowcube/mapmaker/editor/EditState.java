...
public final class EditState {
    private static final Codec<Map<Integer, ItemStack>> LEGACY_ITEM_STACK_MAP_AS_BASE64 = Codec.STRING.transform(
            s -> {
            ...
            _ -> {
                throw new UnsupportedOperationException("cannot write using legacy codec");
            });
    @TestOnly
    static final Codec<Map<Integer, ItemStack>> INVENTORY_CODEC = ExtraCodecs.INT_STRING.mapValue(ItemStack.CODEC)
            .orElse(LEGACY_ITEM_STACK_MAP_AS_BASE64);
