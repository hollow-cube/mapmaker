...
public class V1451_5 extends DataVersion {
    ...
    private static Value fixSpawnEggItemId(Value itemStack) {
    ...
    private static Value fixWolfEntityColor(Value entity) {
        var collarColor = entity.get("CollarColor").as(Number.class, 0).intValue();
        entity.put("CollarColor", 15 - collarColor);
        return null;
    }

    private static Value fixBannerBlockEntityColor(Value blockEntity) {
