...
public class V3945 extends DataVersion {
    ...
    private static @Nullable Value fixJukeboxTicksSinceStarted(Value blockEntity) {
    ...
    private static @Nullable Value fixAttributesForEntity(Value entity) {
    ...
    private static @Nullable Value fixAttributesForComponents(Value components) {
    ...
    private static @Nullable Value fixModifiers(Value modifiers) {
    ...
    public static @Nullable UUID uuidFromIntArray(int @Nullable [] is) {
