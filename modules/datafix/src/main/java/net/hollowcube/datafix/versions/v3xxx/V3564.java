...
public class V3564 extends DataVersion {
    public V3564() {
        ...
        addFix(DataType.BLOCK_ENTITY, "minecraft:sign", V3564::fixDropInvalidSignData);
        addFix(DataType.BLOCK_ENTITY, "minecraft:hanging_sign", V3564::fixDropInvalidSignData);
    }
