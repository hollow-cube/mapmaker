...
public class V3439 extends DataVersion {
    ...
    public V3439() {
        ...
        addFix(DataType.BLOCK_ENTITY, "minecraft:sign", V3439::fixSignBlockEntityDoubleSidedText);
        addFix(DataType.BLOCK_ENTITY, "minecraft:hanging_sign", V3439::fixSignBlockEntityDoubleSidedText);
    }
