...
public final class Hats {
    ...
    public static Cosmetic TOP_HAT = builder("top_hat").rarity(Rarity.COMMON).colorable().build();
    public static Cosmetic SUNGLASSES = builder("sunglasses").rarity(Rarity.COMMON).colorable().build();
    ...
    public static Cosmetic BIKERS_HELMET = builder("bikers_helmet").rarity(Rarity.RARE).colorable().build();
    public static Cosmetic SAMURAI_HELMET = builder("samurai_helmet").rarity(Rarity.RARE).build();
    public static Cosmetic KITSUNE_MASK = builder("kitsune_mask").rarity(Rarity.RARE).colorable().build();
    public static Cosmetic APPRENTICE_HAT = builder("apprentice_hat").rarity(Rarity.RARE).colorable().build();
    public static Cosmetic WIZARD_HAT = builder("wizard_hat").rarity(Rarity.RARE).colorable().build();
    //    public static Cosmetic MINERS_HELMET = builder("miners_helmet").rarity(Rarity.RARE).build();
    public static Cosmetic KNIGHT_HELMET = builder("knight_helmet").rarity(Rarity.RARE).colorable().build();
