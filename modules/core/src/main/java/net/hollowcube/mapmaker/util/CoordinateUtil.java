...
public final class CoordinateUtil {
    ...
    public static boolean intersects(Point min1, Point max1, Point min2, Point max2) {
    ...
    public static boolean intersects(Point pos1, BoundingBox bb1, Point pos2, BoundingBox bb2) {
    ...
    public static boolean isBetween(Point min, Point max, Point p) {
    ...
    public static Vec lerp(Point zero, Point one, float t) {
        return new Vec(lerp(zero.x(), one.x(), t), lerp(zero.y(), one.y(), t), lerp(zero.z(), one.z(), t));
    }

    public static Pos lerp(Pos zero, Pos one, float t) {
        return new Pos(
                lerp(zero.x(), one.x(), t),
                lerp(zero.y(), one.y(), t),
                lerp(zero.z(), one.z(), t),
    ...
    public static List<Component> asTranslationArgs(Point point) {
        return List.of(
    ...
    public static List<Component> asTranslationArgs(Pos pos) {
