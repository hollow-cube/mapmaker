...
public class MapLeaderboardCommand extends CommandDsl {
    ...
    public MapLeaderboardCommand(@NotNull ApiClient api, @NotNull MapService mapService) {
        super("lb");
        ...
        addSubcommand(new MapLeaderboardDeleteCommand(api, mapService));
        addSubcommand(new MapLeaderboardRestoreCommand(mapService, api.maps));
    }
