...
public sealed interface CostEntry permits CostEntry.Cubits, CostEntry.Coins, CostEntry.BackpackItem {
    ...
    int getCount(@NotNull LocalPlayer playerData, @NotNull PlayerBackpack backpack);
    ...
    final class Cubits implements CostEntry {
        ...
        @Override
        public int getCount(@NotNull LocalPlayer playerData, @NotNull PlayerBackpack backpack) {
