...
public final class ItemUtils {
    ...
    public static Component translation(Material material) {
    ...
    public static ItemStack asDisplay(Material material) {
        return asDisplay(material, null);
    }

    public static ItemStack asDisplay(Material material, @Nullable String overlay) {
