...
public record EditLivesAction(
    ...
    public record Data(int value, int max, @Nullable RelativePos deathPosition) {
        ...
        public Data withMax(int max) {
            return new Data(this.value, max, this.deathPosition);
        }
    }

    public EditLivesAction withOperation(Operation operation) {
        return new EditLivesAction(operation, this.lives, this.deathPosition);
    }

    public EditLivesAction withLives(int lives) {
    ...
    private static Sprite makeSprite(@Nullable EditLivesAction action) {
    ...
    private static TranslatableComponent makeThumbnail(@Nullable EditLivesAction action) {
    ...
    private static class Editor extends AbstractActionEditorPanel<EditLivesAction> {
        ...
        @Override
        protected void update(EditLivesAction data) {
