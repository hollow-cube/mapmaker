...
import static net.hollowcube.mapmaker.gui.common.ExtraPanels.LORE_POSTFIX_NOT_AVAILABLE;
...
public class CoordinateActionEditor<T extends CoordinateAction<T>> extends AbstractActionEditorPanel<@NotNull T> {
    ...
    protected void update(T action) {
        ...
        commandButton.lorePostfix(host.hasTag(CoordinateAction.SPC_TARGET_TAG)
