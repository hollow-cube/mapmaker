...
public sealed interface LegacyScriptContext extends ThreadData, TagHandler {

    static LegacyScriptContext get(LuaState state) {
    ...
    non-sealed interface World extends LegacyScriptContext {

    }

    non-sealed interface Player extends LegacyScriptContext {
    ...
    @Override
    default LegacyScriptContext scriptContext() {
        return this;
    }
