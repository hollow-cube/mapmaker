...
public class ControlledDecimalInput extends Panel {
    ...
    public ControlledDecimalInput(String key, Consumer<Double> onChange) {
        this(key, onChange, false);
    }

    public ControlledDecimalInput(String key, Consumer<Double> onChange, boolean oneSlotHack) {
    ...
    public ControlledDecimalInput formatted(DoubleFunction<String> formatter) {
        this.formatter = formatter;
        return this;
    }

    public ControlledDecimalInput parsed(DoubleFunction<String> toString, ToDoubleFunction<String> fromString) {
        this.toString = toString;
        this.fromString = fromString;
        return this;
    }

    public ControlledDecimalInput range(double min, double max) {
        this.min = min;
        this.max = max;
        return this;
    }

    public ControlledDecimalInput stepped(double small, double big) {
