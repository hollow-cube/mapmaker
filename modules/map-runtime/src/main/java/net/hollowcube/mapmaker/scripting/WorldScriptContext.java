...
//    private static final Tag<LegacyScriptContext.Player> PLAYER_SCRIPT_CONTEXT = Tag.Transient("hub/scripting-thread-ref");
//    private static final Tag<LegacyScriptContext.World> WORLD_SCRIPT_CONTEXT = Tag.Transient("hub/scripting-thread-ref-world");
//
...
//            if (isZip) {
//                var resolver = new BundleModuleLoader(LUAU_COMPILER, baseUrlOrZip);
...
//
//    //todo move elsewhere
//    private static final class PlayerContextImpl implements LegacyScriptContext.Player {
...
//    }
//
//    private static final class WorldContextImpl implements LegacyScriptContext.World {
//        private final MapWorld world;
//        private final TagHandler tagHandler;
//        private final List<Disposable> disposables;
//
