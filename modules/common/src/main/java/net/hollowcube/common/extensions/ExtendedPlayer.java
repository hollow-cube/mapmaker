...
public class ExtendedPlayer extends Player {
    ...
    public ExtendedPlayer(PlayerConnection connection, GameProfile profile) {
    ...
    private static double getFluidHeight(Block block) {
    ...
    public BoundingBox getBoundingBox(EntityPose pose) {
        if (pose == EntityPose.SLEEPING) {
            return Objects.requireNonNull(BoundingBox.fromPose(pose)); // Vanilla doesnt scale sleeping box
        }
