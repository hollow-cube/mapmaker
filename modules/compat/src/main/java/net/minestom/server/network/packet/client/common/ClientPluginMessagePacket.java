...
// Patch of minestom to get rid of 32kb limit on plugin message packet data length.
// Probably could become a SystemFlag in the future, but idk quite yet.
public record ClientPluginMessagePacket(String channel, byte[] data) implements ClientPacket.Configuration, ClientPacket.Play {
    ...
    public ClientPluginMessagePacket {
        ...
        // Check.argCondition(data.length > Short.MAX_VALUE, "Data cannot be more than 32kb long");
        data = data.clone();
    }
