...
class CronTest {
    ...
    void everyFiveMinutes_isTheNextAlignedBoundary() {
        assertEquals(
            Instant.parse("2026-08-29T12:05:00Z"),
            next("*/5 * * * *", "2026-08-29T12:03:17Z")
        );
        // Exactly on a boundary means the next one, so a run cannot fire twice for one boundary.
        assertEquals(
            Instant.parse("2026-08-29T12:10:00Z"),
            next("*/5 * * * *", "2026-08-29T12:05:00Z")
        );
        assertEquals(
            Instant.parse("2026-08-29T12:05:00Z"),
            next("*/5 * * * *", "2026-08-29T12:04:59.999Z")
        );
        assertEquals(
            Instant.parse("2026-08-30T00:00:00Z"),
            next("*/5 * * * *", "2026-08-29T23:57:00Z")
        );
    }
    ...
    void jumpsWholeFieldsRatherThanWalking() {
        assertEquals(
            ...
            next("0 4 * * *", "2026-08-29T05:00:00Z")
        );
        assertEquals(
            Instant.parse("2026-08-29T04:30:00Z"),
            next("30 4 * * *", "2026-08-29T04:00:00Z")
        );
        assertEquals(
            Instant.parse("2026-09-01T00:00:00Z"),
            next("0 0 1 * *", "2026-08-15T00:00:00Z")
        );
        assertEquals(
            Instant.parse("2027-01-01T00:00:00Z"),
            next("0 0 1 1 *", "2026-08-15T00:00:00Z")
        );
        assertEquals(
        ...
        assertEquals(
            Instant.parse("2026-08-29T23:45:00Z"),
            next("15,45 * * * *", "2026-08-29T23:20:00Z")
        );
        assertEquals(
            Instant.parse("2026-08-29T09:00:00Z"),
            next("0 9-17 * * *", "2026-08-29T03:00:00Z")
        );
    }
    ...
    void weekdays_countFromSundayAndSevenIsSundayToo() {
        ...
        assertEquals(
            ...
            next("0 0 * * 1", "2026-08-29T00:00:00Z")
        );
        assertEquals(
            Instant.parse("2026-08-30T00:00:00Z"),
            next("0 0 * * 0", "2026-08-29T00:00:00Z")
        );
        assertEquals(
            Instant.parse("2026-08-30T00:00:00Z"),
            next("0 0 * * 7", "2026-08-29T00:00:00Z")
        );
        assertEquals(
            Instant.parse("2026-08-31T00:00:00Z"),
            next("0 0 * * 1-5", "2026-08-29T00:00:00Z")
        );
    }
    ...
    void bothDayFieldsRestricted_matchesEither() {
        ...
        assertEquals(
            ...
            next("0 0 15 * 1", "2026-09-10T00:00:00Z")
        );
        assertEquals(
            Instant.parse("2026-09-15T00:00:00Z"),
            next("0 0 15 * 1", "2026-09-14T00:00:00Z")
        );
    }
