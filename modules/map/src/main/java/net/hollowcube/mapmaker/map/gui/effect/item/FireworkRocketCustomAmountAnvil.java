...
public class FireworkRocketCustomAmountAnvil extends View {
    public static final String SIG_UPDATE_NAME = "firework_rocket_custom_amount.update";
    ...
    public FireworkRocketCustomAmountAnvil(@NotNull Context context, @Nullable String startingInput) {
        super(context);

        titleText.setText("Set Firework Amount");
