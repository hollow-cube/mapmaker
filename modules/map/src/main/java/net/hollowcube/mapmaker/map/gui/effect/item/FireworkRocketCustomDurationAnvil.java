...
public class FireworkRocketCustomDurationAnvil extends View {
    public static final String SIG_UPDATE_NAME = "firework_rocket_custom_duration.update";
    ...
    public FireworkRocketCustomDurationAnvil(@NotNull Context context, @Nullable String startingInput) {
        super(context);

        titleText.setText("Set Firework Duration");
