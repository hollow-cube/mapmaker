...
public class BaseEffectNameAnvil extends View {
    public static final String SIG_UPDATE_NAME = "base_effect.update_name";
    ...
    public BaseEffectNameAnvil(@NotNull Context context, @Nullable String startingInput) {
        super(context);

        titleText.setText("Set Name");
