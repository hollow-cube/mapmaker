...
public class TridentRiptideCustomLevelAnvil extends View {
    public static final String SIG_UPDATE_NAME = "riptide_custom_level.update";
    ...
    public TridentRiptideCustomLevelAnvil(@NotNull Context context, @Nullable String startingInput) {
        super(context);

        titleText.setText("Set Riptide Level");
