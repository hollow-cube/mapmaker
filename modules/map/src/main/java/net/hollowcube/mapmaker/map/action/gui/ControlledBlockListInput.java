...
public class ControlledBlockListInput extends Panel {
    ...
    public ControlledBlockListInput(int width, @NotNull Consumer<List<Block>> onChange) {
        super(width, 1);
    ...
    public void update(@NotNull List<Block> blocks) {
        clear();
    ...
    public static Button makeBlockButton(@NotNull Block block) {
