...
public class BiomeNameInputAnvil extends View {
    public static final String SIG_UPDATE_NAME = "biome.update_name";
    ...
    public BiomeNameInputAnvil(@NotNull Context context, @Nullable String startingInput) {
        super(context);
    ...
    public void handleAnvilInput(@NotNull String input) {
        this.input = FontUtil.stripNonAlphanumeric(input);
