...
//        blockManager.registerBlockPlacementRule(new RedstonePlacementRule());
        ...
        blockManager.registerBlockPlacementRule(new AxisPlacementRule(Block.INFESTED_DEEPSLATE));
        ...
        blockManager.registerBlockPlacementRule(new BlockStackingPlacementRule(
                Block.SEA_PICKLE.withProperty("waterlogged", "false"),
                BlockStackingPlacementRule.SEA_PICKLE_PROPERTY)
        );
        blockManager.registerBlockPlacementRule(new BlockStackingPlacementRule(
                Block.TURTLE_EGG,
                BlockStackingPlacementRule.TURTLE_EGGS_PROPERTY)
        );
