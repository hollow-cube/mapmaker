...
import net.hollowcube.map2.util.PlayerUtil;
import net.minestom.server.instance.block.Block;
import org.jetbrains.annotations.NotNull;

@SuppressWarnings("UnstableApiUsage")
public class EmptyBucketInteractionRule implements net.hollowcube.map2.block.interaction.BlockInteractionRule, net.hollowcube.map2.block.interaction.BlockInteractionRule.AirInteractionRule {
