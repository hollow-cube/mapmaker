...
public class MockMapServer implements MapServer {
    ...
    public @NotNull MetricWriter metrics() {
        return Objects.requireNonNull(metrics, "MetricWriter is not initialized");
    }
    ...
    public @NotNull MapAllocator allocator() {
        return Objects.requireNonNull(allocator, "MapAllocator is not initialized");
    }
