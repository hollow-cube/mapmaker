...
public class CopperGolemEntity extends AbstractMobEntity<CopperGolemMeta> {
    ...
    public static final MapEntityInfo<CopperGolemEntity> INFO = MapEntityInfo.<CopperGolemEntity>builder(AbstractLivingEntity.INFO)
    ...
    public CopperGolemEntity(UUID uuid) {
