...
public class DebugStickItem extends VanillaItemHandler {
    ...
    private DebugStickItem() {
        super(Material.DEBUG_STICK, false, RIGHT_CLICK_BLOCK | LEFT_CLICK_BLOCK);
    }
    ...
    private void sendActionBar(@NotNull Player player, @NotNull String message) {
        PlayerHud.forPlayer(player).showMessage(Component.text(message));
    }
