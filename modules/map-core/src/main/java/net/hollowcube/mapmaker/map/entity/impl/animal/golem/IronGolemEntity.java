...
public class IronGolemEntity extends AbstractMobEntity<IronGolemMeta> {
    ...
    public static final MapEntityInfo<IronGolemEntity> INFO = MapEntityInfo.<IronGolemEntity>builder(AbstractLivingEntity.INFO)
    ...
    public IronGolemEntity(UUID uuid) {
