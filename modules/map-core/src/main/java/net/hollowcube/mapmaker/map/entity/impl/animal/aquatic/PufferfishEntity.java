...
public class PufferfishEntity extends AbstractFishEntity<PufferfishMeta> {
    ...
    public static final MapEntityInfo<PufferfishEntity> INFO = MapEntityInfo.<PufferfishEntity>builder(AbstractFishEntity.INFO)
    ...
    public PufferfishEntity(UUID uuid) {
