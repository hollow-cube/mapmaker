...
public class MarkerEntityEnteredEvent implements PlayerInstanceEvent, MapWorldEvent {
    private final MapWorld world;
    private final Player player;
    private final MarkerEntity marker;

    public MarkerEntityEnteredEvent(@NotNull MapWorld world, @NotNull Player player, @NotNull MarkerEntity marker) {
        this.world = world;
        this.player = player;
        this.marker = marker;
    }
