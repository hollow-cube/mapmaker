...
public final class BlockTags {
    ...
    public static final Collection<Key> WOODEN_BUTTONS = builtin("minecraft:wooden_buttons");
    public static final Collection<Key> STONE_BUTTONS = builtin("minecraft:stone_buttons");
    ...
    public static final Collection<Key> CUSHION_USES_COLLISION_SHAPE = builtin("minecraft:cushion_uses_collision_shape");
