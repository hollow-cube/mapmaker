...
public class CamelEntity extends AbstractHorseEntity<CamelMeta> {

    public static final MapEntityInfo<@NotNull CamelEntity> INFO = MapEntityInfo.<CamelEntity>builder(AbstractHorseEntity.INFO)
    ...
    public CamelEntity(@NotNull UUID uuid) {
        super(EntityType.CAMEL, uuid);
    }
