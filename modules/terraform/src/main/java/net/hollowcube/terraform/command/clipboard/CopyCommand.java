...
public class CopyCommand extends CommandDsl {

    public CopyCommand() {
        super("copy");

        addSyntax(playerOnly(this::handleCopySelection));
    }

    private void handleCopySelection(@NotNull Player player, @NotNull CommandContext context) {
