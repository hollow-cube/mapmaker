...
public class AffineTransform {
    ...
    public AffineTransform translate(Point vec) {
    ...
    public AffineTransform scale(Vec vec) {
        return scale(vec.x(), vec.y(), vec.z());
    }

    public Point apply(Point vector) {
...
//        vector = vector.mutZ(z);
    ...
    public Point apply2(Point vector) {
        double x = vector.x();
        double y = vector.y();
        double z = vector.z();

        double resultX = m00 * x + m01 * y + m02 * z + m03;
        double resultY = m10 * x + m11 * y + m12 * z + m13;
        double resultZ = m20 * x + m21 * y + m22 * z + m23;
