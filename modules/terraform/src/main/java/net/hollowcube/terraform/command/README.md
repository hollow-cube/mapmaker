# Terraform commands
Command set native to terraform. Always uses a single slash, whereas compatibility commands use a double slash (like native WorldEdit). All terraform commands are also aliased as `/tf:command`.
